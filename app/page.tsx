      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <section className="pt-12 pb-12 md:pt-4 md:pb-16">
          <div className="flex flex-col md:grid md:grid-cols-2 md:items-start gap-8 md:gap-12">
            <p className="text-sm font-medium text-text-secondary mb-4 uppercase tracking-wide order-1 md:[grid-column:1] md:[grid-row:1]">
              Field Guide
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-text-primary mb-6 leading-tight text-center md:text-left order-2 md:[grid-column:1] md:[grid-row:2]">
            ...
            <div className="relative w-full h-[350px] md:h-[450px] rounded-lg overflow-hidden order-3 md:[grid-row:1/span-4] md:[grid-column:2]">
              <Image
            ...
            <p className="text-lg text-text-secondary mb-8 leading-relaxed order-4 md:[grid-column:1] md:[grid-row:3]">
            ...
            <button
              ...
              className="w-fit bg-button-bg text-button-text px-6 py-3 rounded-full font-medium transition-all duration-150 ease-out hover:-translate-y-0.5 hover:shadow-md order-5 md:[grid-column:1] md:[grid-row:4]"
            >
              Browse all plants
            </button>
            
            {/* Search + Categories */}
            <div className="mt-8 md:mt-4 order-6 md:[grid-column:1] md:[grid-row:5]">
              <div className="mb-8">
